            ...
            <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-4">
                                    ...
                                    <span>
                                        <input type="hidden" id="visitor_edit_id" name="visitor_user_id" value="<?= $u_id ?>">
                                        <input type="hidden" id="visitor_edit_mpid" name="visitor_user_id" value="<?= $medItem['mp_id'] ?>">
                                        <input type="hidden" id="visitor_edit_mhid" name="visitor_user_id" value="<?= $medItem['mh_id'] ?>">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="visitor_edit_medicationPresent"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" id="visitor_edit_diagnosis" class="form-control form-control-md" value="<?= isset($medItem['mp_diagnosis']) ? $medItem['mp_diagnosis'] : '' ?>">
                            </div>
                            <div class="form-group">
                                <label>Treatment</label>
                                <input disabled type="text" id="visitor_edit_treatment" class="form-control form-control-md" value="<?= isset($medItem['mp_treatment']) ? $medItem['mp_treatment'] : '' ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input id="visitor_edit_hyperthension" class="form-check-input" type="checkbox" <?= (isset($medItem['Hyperthension']) && $medItem['Hyperthension'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Hypertension</label>
                                </div>
                                <div class="form-check">
                                    <input id="visitor_edit_diabetes" class="form-check-input" type="checkbox" <?= (isset($medItem['Diabetes']) && $medItem['Diabetes'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Diabetes</label>
                                </div>
                                <div class="form-check">
                                    <input id="visitor_edit_cardio" class="form-check-input" type="checkbox" <?= (isset($medItem['Cardiovascular_desease']) && $medItem['Cardiovascular_desease'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Cardiovascular (Heart) Disease</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_ptb" <?= (isset($medItem['PTB']) && $medItem['PTB'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">PTB</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_hyperacidity" <?= (isset($medItem['Hyperacidity']) && $medItem['Hyperacidity'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Hyperacidity</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_allergy" <?= (isset($medItem['Allergy']) && $medItem['Allergy'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Allergy</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_epilepsy" <?= (isset($medItem['Epilepsy']) && $medItem['Epilepsy'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Epilepsy</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_asthma" <?= (isset($medItem['Asthma']) && $medItem['Asthma'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Asthma</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_dysmenorrhea" <?= (isset($medItem['Dysmenorrhea']) && $medItem['Dysmenorrhea'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Dysmenorrhea</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="visitor_edit_liver" <?= (isset($medItem['liver_Desease']) && $medItem['liver_Desease'] == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label">Liver/Gall Bladder Disease</label>
                                </div>
                                <div class="mt-3">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Others"
                                            id="visitor_edit_other_disease"><?=  $medItem['other_disease'] ?></textarea>
                                        <label for="visitor_edit_other_disease">Others: </label>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col text-end">
                        ...
                        <button type="submit" id="visitor_medical_update_btn" name="registerbtn"
