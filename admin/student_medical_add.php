                ...
                <div class="col-6" style="border-right: 2px solid #9ca3af">
                    <div>
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <span>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="student_medicationPresent"
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="text" id="student_diagnosis" class="form-control form-control-md">
                        </div>
                        <div class="form-group">
                            <label>Treatment</label>
                            <input disabled type="text" id="student_treatment" class="form-control form-control-md">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input id="student_hyperthension" class="form-check-input" type="checkbox">
                                <label class="form-check-label">
                                    Hyperthension
                                </label>
                            </div>
                            <div class="form-check">
                                <input id="student_diabetes" class="form-check-input" type="checkbox">
                                <label class="form-check-label">
                                    Diabetes
                                </label>
                            </div>
                            <div class="form-check">
                                <input id="student_cardio" class="form-check-input" type="checkbox">
                                <label class="form-check-label">
                                    Cardiovascular(Heart)Desease
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_ptb">
                                <label class="form-check-label">
                                    PTB
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_hyperacidity">
                                <label class="form-check-label" for="defaultCheck2">
                                    Hyperacidity
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_allergy">
                                <label class="form-check-label" for="defaultCheck2">
                                    Allergy
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_epilepsy">
                                <label class="form-check-label" for="defaultCheck2">
                                    Epilepsy
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_asthma">
                                <label class="form-check-label" for="defaultCheck2">
                                    Asthma
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_dysmenorrhea">
                                <label class="form-check-label" for="defaultCheck2">
                                    Dysmenorrhea
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="student_liver">
                                <label class="form-check-label" for="defaultCheck2">
    ...
    $(document).ready(function () {
        $('input[type="radio"][name="student_medicationPresent"]').change(function () {
            if ($(this).val() == "1") {
                $('#diagnosisGroup').show();
                $('#treatmentGroup').show();
                $('#student_diagnosis, #student_treatment').prop('disabled', false);
            } else {
                $('#diagnosisGroup').hide();
                $('#treatmentGroup').hide();
                $('#student_diagnosis, #student_treatment').prop('disabled', true);
                $('#student_diagnosis, #student_treatment').val('');
            }
        });
    });
</script>