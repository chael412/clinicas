<!-- Add Modal -->
<div class="modal fade" id="modal_visitorADD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form id="visitorform_add">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="visitor_add_btn" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
