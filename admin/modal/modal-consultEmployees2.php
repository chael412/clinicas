<!-- Add Modal -->
<div class="modal fade" id="modal_consultADD12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Monthly Consultation</h5>
      ...
      <form id="consultform_add2">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <button id="search_consult_btn12" type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                      data-target="#modal_consultREQ12">Select</button>
                  </div>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="col-12">
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody id="medicalData_employee2">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="consult_add_btn12"
...
<div class="modal fade" id="modal_consultREQ12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
        ...
        <table class=" table table-bordered table-sm" width="100%" cellspacing="0">
          <thead class="thead-light">
            <tr>
              ...
              <th style="width: 65%">Fullnamex</th>
              <th style="width: 20%"></th>
            </tr>
          </thead>

          <tbody class="consultsearch_table12">
