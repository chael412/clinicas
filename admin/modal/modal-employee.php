<!-- Add Modal -->
<div class="modal fade" id="modal_employeeADD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form id="employeeform_add">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="employee_add_btn" name=""
