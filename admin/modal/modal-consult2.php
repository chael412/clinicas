<!-- Add Modal -->
<div class="modal fade" id="modal_consultADD2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form id="consultform_add3">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <button id="search_consult_btn2" type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                      data-target="#modal_consultREQ2">Select</button>
                  </div>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="consult_add_btn2"
...
<div class="modal fade" id="modal_consultREQ2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content px-2 py-1">
      ...
      <div class="float-end mb-1">
        <input id="Studentsearch_input2" type="text" class="float-end form-control form-control-sm w-25 m-1"
      ...
      <div class="table-responsive">
        <table class=" table table-bordered table-sm" width="100%" cellspacing="0">
          ...
          <tbody class="consultsearch_table2">
