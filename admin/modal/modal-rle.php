<!-- Add Modal -->
<div class="modal fade" id="modal_rleADD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form id="rleform_add">
        ...
        <div class="modal-body">
          ...
          <div class="form-group d-flex flex-column">
            ...
            <a href="#" class="btn btn-primary btn-icon-split">
              ...
              <button id="search_rle_btn" type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                data-target="#modal_rleREQ">Select</button>
            </a>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="rlemed_add_btn" name=""
...
<div class="modal fade" id="modal_rleREQ" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
