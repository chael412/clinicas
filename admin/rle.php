...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-brown">RLE
                <button type="button" class="d-none d-sm-inline-block float-right btn btn-sm btn-success shadow-sm m-1"
                    data-toggle="modal" data-target="#modal_rleADD"><i class="fas fa-plus mx-1"></i>Create
                    MedCert</button>
            </h5>
        </div>
        <div class="card-body">
            ...
            ORDER BY rle.rle_id DESC 
            ";
            $query_run = mysqli_query($conn, $query);

            ?>
            <div class="table-responsive">
                <table id="datatableid" class="rle_table table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col col-lg-2">
                                                <form action="rle_view.php" method="POST">
                                                    <input type="hidden" name="view_id" value="<?= $row['rle_id']; ?>">
                                            ...
                                            <div class="col col-lg-2 mx-1">
                                                <form action="ojt_edit.php" method="POST">
                                                    <input type="hidden" name="edit_ojt" value="<?= $row['rle_id']; ?>">
