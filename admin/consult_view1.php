...
<div class="container-fluid">
    ...
    if (isset($_POST['view_medcert_btn'])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            <div class="row">
                <div class="col-12">
                    <a class="btn btn-primary btn-sm float-right mb-1" href="consult1.php" role="button">
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center text-primary">
                                <h4>Employee Consultation Information for <?= $user_fullname ?></h4>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr style="border-bottom: 3px solid #22c55e">
                                ...
                                <td>
                                    ...
                                    <span>
                                        <form action="consult_edit1.php" method="POST">
